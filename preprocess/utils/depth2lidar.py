...
if __name__ == '__main__':
    ...
    # parser.add_argument('--calib_dir', type=str, default='./kitti/dataset/sequences/00')
    parser.add_argument('--calib_dir', type=str, default=None)
    parser.add_argument('--depth_dir', type=str, default='./kitti/depth/sequences/00')
    parser.add_argument('--save_dir', type=str, default='./kitti/lidar_dir/sequences/00')
    ...
    for fn in depths:
        ...
        calib_file = '{}/{}.txt'.format(args.calib_dir, 'calib') if args.calib_dir is not None else None
