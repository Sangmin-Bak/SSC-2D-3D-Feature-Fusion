...
class CustomMVXTwoStageDetector(Base3DDetector):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(CustomMVXTwoStageDetector, self).__init__(init_cfg=init_cfg)
        ...
        if pts_bbox_student_head:
            pts_train_cfg = train_cfg.pts if train_cfg else None
            pts_bbox_student_head.update(train_cfg=pts_train_cfg)
            pts_test_cfg = test_cfg.pts if test_cfg else None
            pts_bbox_student_head.update(test_cfg=pts_test_cfg)
            self.pts_bbox_student_head = builder.build_head(pts_bbox_student_head)
    ...
    def with_pts_bbox(self):
        ...
        return hasattr(self,
                       'pts_bbox_student_head') and self.pts_bbox_student_head is not None
    ...
    def forward_pts_train(self,
        ...
        """
        outs = self.pts_bbox_student_head(pts_feats)
        loss_inputs = outs + (gt_bboxes_3d, gt_labels_3d, img_metas)
        losses = self.pts_bbox_student_head.loss(
    ...
    def simple_test_pts(self, x, img_metas, rescale=False):
        ...
        outs = self.pts_bbox_student_head(x)
        bbox_list = self.pts_bbox_student_head.get_bboxes(
    ...
    def aug_test_pts(self, feats, img_metas, rescale=False):
        ...
        merged_bboxes = merge_aug_bboxes_3d(aug_bboxes, img_metas,
                                            self.pts_bbox_student_head.test_cfg)
