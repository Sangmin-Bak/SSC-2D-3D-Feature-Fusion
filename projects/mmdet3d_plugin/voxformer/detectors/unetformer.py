...
class UNetFormer(MVXTwoStageDetector):
    def __init__(self,
                 use_grid_mask=False,
        ...
        self.occ_head = builder.build_head(occ_head) if occ_head is not None else None
    ...
    def forward_pts_train(self,
        ...
        """Forward function'
        """
        outs = self.pts_bbox_head(img_feats, img_metas, voxel_feats, target)
    ...
    def forward_train(self,
        ...
        if self.occ_head is not None:
            voxel_feats = self.occ_head(voxel)
        else:
            voxel_feats = None
        img_feats = self.extract_feat(img=img) 
        losses = dict()
        losses_pts = self.forward_pts_train(img_feats, img_metas, voxel_feats, target)
