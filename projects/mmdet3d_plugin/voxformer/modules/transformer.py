...
class PerceptionTransformer(BaseModule):
    ...
    def init_weights(self):
        ...
        # xavier_init(self.voxel_feature_map, distribution='uniform', bias=0.)
    ...
    def get_vox_features(
        ...
        if ref_3d is not None:
            ref_3d = torch.from_numpy(ref_3d) 
        ...
        # bev_embed = bev_embed + voxel_feats.flatten(2).permute(0, 2, 1)
